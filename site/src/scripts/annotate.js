...
(function () {
  ...
  var EXCLUDE = ".katex, .terminal, .slides, .pane-grip, .exercise__answer, .site-header, .site-footer, .annot-rail, .annot-bar, .a11y-panel, [data-settings-panel], .toc, .toc-m, .cmd, .cmdk, .h-anchor, .course-nav, script, style, .annot-skip";
  ...
  var KEY = "annot:" + location.pathname;
  var lastColor = "amber";
  ...
  function exportNotes() {
    ...
    a.download = ("notes" + location.pathname).replace(/[^a-z0-9]+/gi, "-").replace(/-+$/, "") + ".json";
